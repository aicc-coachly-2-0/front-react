...
const RefundListPageCommon = ({ title, columns, data }) => {
  return (
      ...
      >
        <Box display="flex" gap={2}>
          <Select defaultValue="recent" size="small">
            <MenuItem value="recent">최근 요청순</MenuItem>
            <MenuItem value="oldest">오래된 요청순</MenuItem>
          </Select>
...
export default RefundListPageCommon;
